defmodule FluidServerWeb.Plugs.Auth do
  @moduledoc """
  ...
  In your router:
      ...
      pipeline :authenticated do
        plug FluidServerWeb.Plugs.Auth
      end

      pipeline :read_access do
        plug FluidServerWeb.Plugs.Auth, scopes: ["doc:read"]
      end

      pipeline :write_access do
        plug FluidServerWeb.Plugs.Auth, scopes: ["doc:read", "doc:write"]
      end
