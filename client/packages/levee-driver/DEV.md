...
The TypeScript types in `src/generated/protocol-types.ts` are auto-generated from Gleam protocol types provided by `tylerbutler/spillway` and generated through the Levee server. **Do not edit this file manually.**

### Schema Architecture

```
tylerbutler/spillway/src/spillway/schema.gleam        (Source of truth)
                        │
                        ▼ mix generate_schema
...
|----------|------|---------|
| spillway | `src/spillway/schema.gleam` | Gleam type definitions (source of truth) |
