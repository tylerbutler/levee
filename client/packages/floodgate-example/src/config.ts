/**
 * Configuration types and helpers for the Floodgate DiceRoller example.
 */
 ...
 *
 * @remarks
 * **⚠️ DEV-ONLY.** Matches `FLOODGATE_TOKEN_MINT_SECRET` on the Task 3
...
/**
 * Configuration options for the Floodgate DiceRoller example.
 */
export interface FloodgateExampleConfig {
