...
# Install Gleam (required for levee_protocol_deps, levee_auth, levee_storage, levee_oauth)
...
COPY server/levee_protocol_deps/gleam.toml server/levee_protocol_deps/manifest.toml levee_protocol_deps/
...
COPY server/levee_protocol_deps levee_protocol_deps
...
COPY --from=builder /build/levee_protocol_deps/build/dev/erlang/ ./levee_protocol_deps/build/dev/erlang/
